            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}"  type="text" required="" placeholder="Phone Number(0712345678)">
                        ...
                        <input class="form-control" name="by" value="{{$ref}}" type="text" placeholder="Referrer (Input (NILL) if you have no referrer)" required>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">I agree to all Terms</a></label> 
                                </div> 
                            </div>
                        </div>
